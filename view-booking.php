...
// ── Flash message from update-status.php redirect ──────────────
...
<div class="ns-table-card ns-table mb-4">
    ...
    <div class="ns-table-header">
        ...
        <a href="export-csv.php?<?php echo buildQuery(); ?>" class="btn btn-sm btn-success d-flex align-items-center gap-1"
    ...
    <div class="table-responsive">
        <table class="table align-middle mb-0">
            ...
            <tr>
                ...
                $verified = !empty($row['payment_verified']) && $row['payment_verified'] == 1;
                if     ($pay == 'Paid')       echo '<span class="ns-badge nb-paid"><i class="bi bi-check-circle-fill"></i>Paid</span>' . ($verified ? '&nbsp;<span title="Razorpay Verified" style="color:#15803d;font-size:.85rem;"><i class="bi bi-patch-check-fill"></i></span>' : '');
                ...
                <div style="font-size:.72rem;color:#888;margin-top:3px;"><?php echo htmlspecialchars(ucfirst($row['payment_method'])); ?></div>
                <?php endif; ?>
                </td>

                <td style="font-size:.78rem;color:#555;max-width:140px;">
                <?php if (!empty($row['razorpay_payment_id'])): ?>
                    <span style="font-family:monospace;word-break:break-all;"><?php echo htmlspecialchars($row['razorpay_payment_id']); ?></span>
                <?php else: ?>
